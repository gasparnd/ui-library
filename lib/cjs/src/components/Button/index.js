...
var Button = function (_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null, !disable ? (react_1.default.createElement("button", __assign({ type: "button", onClick: onClick, className: [
            "" + (ghost ? "button-ghost" : "storybook-button"),
            "storybook-button--" + size,
            mode,
        ].join(" "), style: allS }, props), children)) : (react_1.default.createElement("button", __assign({ type: "button", onClick: function () { }, className: ["button-disable", "storybook-button--" + size, mode].join(" "), style: allS }, props), children))));
};
